...
export declare const ClusterDataV1: import("@ckb-lumos/codec/lib/molecule/layout").ObjectCodec<{
...
export declare const ClusterDataV2: import("@ckb-lumos/codec/lib/molecule/layout").ObjectCodec<{
    name: import("@ckb-lumos/codec/lib/base").BytesCodec<string, BytesLike>;
    description: import("@ckb-lumos/codec/lib/base").BytesCodec<string, BytesLike>;
    mutantId: import("@ckb-lumos/codec/lib/molecule/layout").OptionCodec<import("@ckb-lumos/codec/lib/base").BytesCodec<string, BytesLike>>;
}>;
