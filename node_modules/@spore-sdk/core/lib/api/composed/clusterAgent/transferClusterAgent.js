...
exports.transferClusterAgent = void 0;
const lumos_1 = require("@ckb-lumos/lumos");
const helpers_1 = require("../../../helpers");
const config_1 = require("../../../config");
const cobuild_1 = require("../../../cobuild");
const __1 = require("../..");
async function transferClusterAgent(props) {
    // Env
    ...
    const actionResult = (0, cobuild_1.generateTransferClusterAgentAction)({
        txSkeleton,
...
exports.transferClusterAgent = transferClusterAgent;
